...
\orientadorTitulo{Prof. Dsc.} %%Colocar a titulação do(a) orientador(a) dentro de chaves {}. Ex: Msc., Dr., Dra., etc.
\coorientadorTitulo{Prof. Msc.} %%Colocar a titulação do(a) co-orientador(a) dentro de chaves {}. Ex: Msc., Dr., Dra., etc.
...
\avaliadorUm{Nome e sobrenome Avaliador 1} % Nome e sobrenome
...
\avaliadorDois{Nome e sobrenome Avaliador 2} % Nome e sobrenome
\titulacaoAvaliadorDois{Prof. Msc.} % Titulação
